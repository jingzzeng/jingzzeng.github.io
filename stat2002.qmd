...
![Random experiments, probability distributions, confidence intervals, and hypothesis tests.](figures/stat2002-probability-inference-v2.png){.course-overview-image fig-alt="Four watercolor illustrations: dice and coins for random experiments; a density curve and probability bars; repeated confidence intervals around a reference value; and a null distribution with two shaded p-value tails"}

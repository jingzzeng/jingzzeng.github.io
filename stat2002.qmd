...
This course covers Chapters 1--8 and Section 9.1 of the textbook, developing the foundations of probability theory and mathematical statistics.

The probability component covers random experiments, events and probability; conditional probability, Bayes' formula, and independence; discrete and continuous random variables and their distributions; random vectors and joint distributions; and numerical characteristics including expectation, variance, moments, entropy, the law of large numbers, and the central limit theorem.

The statistical component introduces populations, samples, sampling distributions, and the history and basic ideas of statistics. It then develops point estimation (including the method of moments and maximum likelihood), criteria for evaluating estimators and large-sample theory, interval estimation and bootstrap methods, and hypothesis testing for normal populations and proportions. The course concludes with p-values, likelihood-ratio tests, and goodness-of-fit tests (Section 9.1).
...
::: {.course-qr}
![QR code for the STAT2002 course page.](figures/stat2002-qr.png){.course-qr-image fig-alt="QR code linking to the STAT2002 course page"}

Scan to open the STAT2002 course page on your phone.
:::
